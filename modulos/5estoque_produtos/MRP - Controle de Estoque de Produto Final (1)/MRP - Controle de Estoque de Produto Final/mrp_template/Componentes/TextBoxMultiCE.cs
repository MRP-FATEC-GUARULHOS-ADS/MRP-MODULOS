...
{
    public class TextBoxMultiCE : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            textbox.Location = new Point(this.radius + 2, this.radius + 2);
            textbox.Width = base.Width - ((int)(this.radius * 2 + 2));
            textbox.Height = base.Height - ((int)(this.radius * 2 + 2));
